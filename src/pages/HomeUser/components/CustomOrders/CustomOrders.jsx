...
function CustomOrders() {
  ...
  const fetchCustomOrders = async () => {
    try {
      await axios
        .get(`/customorders/user/${id}`, {
          params: {
            pages: `limit ${orderPerPage} offset ${(page - 1) * orderPerPage}`,
            selectedStatus,
            sort,
            id,
          },
              ...
              <CardContent>
                ...
                <FormControl sx={{ m: 1, minWidth: 420 }}>
                  ...
                  >
                    ...
                    <MenuItem key={2} value="and status = 'waiting'">
                      {" "}
                      Waiting{" "}
                    </MenuItem>
                    <MenuItem key={3} value="and status = 'rejected'">
                      {" "}
                      Rejected{" "}
                    </MenuItem>
                    <MenuItem key={4} value="and status = 'approved'">
                      {" "}
                      Approved{" "}
                    </MenuItem>
                  </Select>
              ...
              <CardContent>
                ...
                <FormControl sx={{ m: 3, minWidth: 200 }}>
                  ...
                  >
                    ...
                    <MenuItem value="order by created_at ASC">
                      {" "}
                      Oldest{" "}
                    </MenuItem>
                    <MenuItem value="order by created_at DESC">
                      {" "}
                      Latest{" "}
                    </MenuItem>
                  </Select>
